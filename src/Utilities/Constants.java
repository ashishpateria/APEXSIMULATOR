...
public class Constants {
	...
	public static final String BRANCH_FU = "BRANCH";
	...
	public static final int SET_URF_SIZE=2;
	public static final int SIMULATE = 3;
	public static final int DISPLAY = 4;
	public static final int PRINT_MAP_TABLES=5;
	public static final int PRINT_IQ=6;
	public static final int PRINT_ROB=7;
	public static final int PRINT_URF=8;
	public static final int PRINT_MEMORY=9;
	public static final int PRINT_STATS=10;
